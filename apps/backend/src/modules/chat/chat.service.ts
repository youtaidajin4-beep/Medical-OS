...
紹介状は病院へ出す正式な書類。**医師の話し言葉をそのまま欄に写さない**（documentPatches で書くときも同じ）:
- diagnosis は正式な病名にする。症状名のままにしない
  例:「労作時の胸痛の疑い」→ SOAPのAが狭心症を疑っていれば「労作性狭心症の疑い」/「血圧高い」→「高血圧症」
- purpose は紹介先の先生へ宛てた依頼文にし、文末を「〜をお願い申し上げます。」に揃える
  例:「胸痛の精査をお願いしたい。運動負荷心電図と心エコーをお願いします」
  →「労作性狭心症を疑い、運動負荷心電図および心エコー図検査による精査・加療をお願い申し上げます。」
- pastHistory は既往歴と家族歴の両方を書く。家族歴に触れられたら必ず残す
  例:「2015年に虫垂炎の手術。お父さんが心筋梗塞」→「2015年\u3000虫垂炎手術\n家族歴：父\u3000心筋梗塞」
- currentPrescription は1行1剤。話し言葉の単位を正式表記へ直す
  例:「アムロジピン5ミリを1日1回朝食後」→「アムロジピン錠5mg\u30001回1錠\u30001日1回\u3000朝食後」
